  ...
  // ─────────────────────────────────────────────
  {
    ...
    stops: [
      ...
      },
      {
        ...
        end: "2026-05-03T19:30",
        title: "Kevin's place",
        neighborhood: "Park Slope",
        address: "353 6th Ave, Brooklyn, NY 11215",
        kind: "lodging",
        note: "Drop bags. Hug. Don't unpack yet.",
        fromPrev: "45 min · cab",
        geo: { lat: 40.6707, lng: -73.9810 },
      },
      {
        id: "d0s3",
        start: "2026-05-03T19:30",
        end: "2026-05-03T21:30",
        title: "Dinner with Kevin · TBD",
        neighborhood: "Park Slope",
        kind: "meal",
        note: "Pick together. Park Slope is forgiving on a Sunday — most spots will seat two on a walk-in.",
        metaNote: "save Bricolage for tomorrow night.",
        fromPrev: "short walk · decide together",
        alternates: [
          {
            id: "a-sun-1",
            title: "Sushi Katsuei",
            neighborhood: "Park Slope",
            kind: "meal",
            reason: "Counter omakase, neighborhood-quiet, walk-in friendly Sunday. Bring tamari for safety.",
            delta: "8 min walk · 7th Ave",
          },
          {
            id: "a-sun-2",
            title: "Hugo & Sons",
            neighborhood: "Park Slope",
            kind: "meal",
            reason: "Italian-leaning bistro on 5th Ave. Easy seat at the bar, GF pasta if you ask.",
            delta: "10 min walk · 5th Ave",
          },
          {
            id: "a-sun-3",
            title: "Rose's",
            ...
            kind: "meal",
            reason: "Stylish neighborhood spot, natural wine, several naturally GF/DF plates.",
            delta: "15 min walk or 5 min cab",
          },
          {
            id: "a-sun-4",
            title: "Whatever Kevin suggests",
            neighborhood: "Park Slope",
            kind: "meal",
            reason: "He lives here. Trust the local.",
            delta: "his call",
          },
        ],
      },
